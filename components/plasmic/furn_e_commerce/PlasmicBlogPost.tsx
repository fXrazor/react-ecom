...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: 9CWjNoJCRXtU/css
...
function PlasmicBlogPost__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__gVvad, {
          [sty.freeBoxlong__gVvaDg8Syr]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__ivkCk)}
              displayHeight={"auto"}
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__p10Ll, {
          [sty.freeBoxlong__p10Llg8Syr]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
