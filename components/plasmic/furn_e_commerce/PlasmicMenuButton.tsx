...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: dza7n4ljeMPK/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: MHHa6K0pWFjI/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: 1Zd-kMzlcENU/icon
...
function PlasmicMenuButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <BarsIcon
          className={classNames(projectcss.all, sty.svg__jiiQf, {
            [sty.svgexpanded__jiiQfzaCiV]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
        ...
        <TimesIcon
          className={classNames(projectcss.all, sty.svg__myEjs, {
            [sty.svgexpanded__myEjszaCiV]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
